...
<svg xmlns="http://www.w3.org/2000/svg"
     viewBox="0 0 216 216" class={cn(iconVariants({ variant, size }), className)} {...restProps}>
    <style type="text/css">
        .st{fill-rule:evenodd;clip-rule:evenodd;}
    </style>
        <g id="Layer_1">
    </g>
        <g id="Isolation_Mode">
        <rect class="fill-none" />
            <g>
            <g>
                <path class="st" d="M172.32,96.79c0,13.78-8.48,25.5-20.29,29.78l7.14,11.83l-10.57,13l10.57,12.71l-17.04,22.87l-12.01-12.82
                ...
                <path class="st" d="M172.41,96.88c0,13.62-8.25,25.23-19.83,29.67l6.58,11.84l-9.73,13l9.73,12.71l-17.03,23.05v-25.9v-32.77
                    v-26.87c4.02,0,7.28-3.41,7.28-7.6c0-4.2-3.26-7.61-7.28-7.61V65.28C158.86,65.28,172.41,79.43,172.41,96.88z"/>
                <path class="st" d="M120.24,131.43c-9.75-8-16.3-20.3-17.2-34.27H50.8c-10.96,0-19.84,9.01-19.84,20.13v25.17
                    c0,5.56,4.44,10.07,9.92,10.07h69.44c5.48,0,9.92-4.51,9.92-10.07V131.43z"/>
                <path d="M73.16,91.13c-2.42-0.46-4.82-0.89-7.11-1.86C57.4,85.64,52.36,78.95,50.73,69.5
